# MapIt-Workout-Tracker

<p id="description">I made this project using leaflet library and used browser based APIs such as localStorage and geolocation. This app provides the functionality to track your activities like running and cycling. Although its usability is limited but i am using it to improve my skills in JS.</p>
 
- 🔭 The link for this project is [Mapit Tracker App](https://mapitworkout.netlify.app/)
